...
- Compression-capable unified and split readers now reject RSV1 on continuation and control frames while accepting it on the first text or binary frame of a compressed message.
