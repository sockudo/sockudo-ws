...
- Client frame encoding copies and masks payloads in portable 64-byte word blocks, allowing compiler vectorization without architecture-specific intrinsics.
