...
- Reduce compression overhead for outgoing messages with `no_context_takeover` by clearing DEFLATE history at completed message boundaries. Context-takeover compression is unchanged; this does not accelerate receiving existing compressed traffic.
