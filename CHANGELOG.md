...
- Reduce UTF-8 validation overhead for ASCII text messages and fragments shorter than 64 bytes. Non-ASCII inputs still receive full validation and may incur an extra ASCII scan.
